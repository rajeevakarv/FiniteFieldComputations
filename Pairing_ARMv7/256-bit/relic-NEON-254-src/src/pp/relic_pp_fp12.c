...
#define USE_NEON_FP12 1    //It was zero
...
// Full dodecic extension field multiplication using lazy reduction
        ...
        TRY {
	     //Fp temp1[12], temp2[12], temp3[12];
	     //Fpk_set(temp1, a, 12);
	     //Fpk_set(temp2, b, 12);
	     //MULT_FP12(temp3, temp1, temp2);
	     //Fpk_set(c, temp3, 12);
...
void fp12_mul_sxs(fp12_t c, fp12_t a, fp12_t b) {
    fp2_t v0, v1, v2, v4, v5, v6, v7, temp1, temp2, temp3, temp4;
	fp2_null(v0);
	fp2_null(v1);
	fp2_null(v2);
	fp2_null(v4);
...
#endif
#if USE_NEON_FP12
		fp2_add(temp1, a[0][0], a[1][0]);
		fp2_add(temp2, b[0][0], b[1][0]);
		fp2_mul_dual(v5, v2, temp1, temp2, a[1][1], b[1][1]);
		
		fp2_add(temp1, a[0][0], a[1][1]);
		fp2_add(temp2, b[0][0], b[1][1]);
		fp2_add(temp3, a[1][0], a[1][1]);
		fp2_add(temp4, b[1][0], b[1][1]);
		fp2_mul_dual(v6, v7, temp1, temp2, temp3, temp4);
...
#if USE_NEON_FP12
		fp2_add(temp1, a[0][0], a[0][1]);
		fp2_add(temp2, b[0][0], b[0][1]);
		fp2_mul_dual(v5, v2, temp1, temp2, a[1][1], b[1][1]);
		
		fp2_add(temp1, a[0][1], a[1][1]);
		fp2_add(temp2, b[0][1], b[1][1]);
		fp2_add(temp3, a[0][0], a[1][1]);
		fp2_add(temp4, b[0][0], b[1][1]);
		fp2_mul_dual(v7, v6, temp1, temp2, temp3, temp4);
