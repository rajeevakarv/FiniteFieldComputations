...
//#define fp2_add(C, A, B)    fp2_add_new(C,A,B)
/**
...
//#define fp2_addd(C, A, B)  fp2_addd_new(C,A,B)
...
//#define fp2_sub(C, A, B)	fp2_sub_new(C,A,B)
...
//#define fp2_subd(C, A, B)  fp2_subd_new(C, A, B)
/**
...
void fp2_add_new(fp2_t c, fp2_t a, fp2_t b);
#endif /* !RELIC_PP_H */
