...
//	fp_mul(c[2][1], a[2][1], b);
	fp_mul_446_dual_NEON(c[0][0], c[0][1], a[0][0], b, a[0][1], b );
	fp_mul_446_dual_NEON(c[1][0], c[1][1], a[1][0], b, a[1][1], b );
	fp_mul_446_dual_NEON(c[2][0], c[2][1], a[2][0], b, a[2][1], b );
}
...
/*	fp_muln_low(C[0][0], a[0][0], b);
	...
	fp_mul_446_dual_NEON_nr(C[0][0], C[0][1], a[0][0], b, a[0][1], b);
	fp_mul_446_dual_NEON_nr(C[1][0], C[1][1], a[1][0], b, a[1][1], b);
	fp_mul_446_dual_NEON_nr(C[2][0], C[2][1], a[2][0], b, a[2][1], b);
}
...
/* fp_muln_low(C[1][0], a[0][0], b);
  ...
  fp_mul_446_dual_NEON_nr(C[1][0], C[1][1], a[0][0], b, a[0][1], b);
  fp_mul_446_dual_NEON_nr(C[2][0], C[2][1], a[1][0], b, a[1][1], b);
  fp_mul_446_dual_NEON_nr(C[0][0], C[0][1], a[2][0], b, a[2][1], b);
  fp2_mul_nord(C[0], C[0]);
}
